...
#Region "Numbers"
    ...
    Public Shared Function Round(value As Double, decimals As Integer) As Double
#If SILVERLIGHT Then
...
#End If
    ...
    Public Shared Function Round(value As Decimal, decimals As Integer) As Decimal
#If SILVERLIGHT Then
        Return Math.Round(value, decimals)
#Else
        Return Math.Round(value, decimals, MidpointRounding.AwayFromZero)
#End If
    ...
    Public Shared Function ToDecimal(value As String) As Decimal
        ...
        Return CDec(Formatting.NumberToCurrentCulture(value))
    End Function
