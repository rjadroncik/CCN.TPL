...
Partial Class ObjektyVyberCheck(Of T As Class)
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New GenericComponentResourceManager(GetType(ObjektyVyberCheck(Of T)))
